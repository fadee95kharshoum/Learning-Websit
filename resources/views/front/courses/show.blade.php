                    ...
                    <div class="my-5">
                        ...
                        <form class="form-contact contact_form" action="{{ route('front.message.enroll') }}" method="post" id="contactForm" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="spec" id type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your speciality'" placeholder = 'Enter your speciality'>
                                    </div>
                                </div>
                            </div>
